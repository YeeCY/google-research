...
@gin.configurable
class OfflineCLearningAgent(tf_agent.TFAgent):
    """An Offline C-learning Agent."""
    ...
    def __init__(self,
                 ...
                 name=None):
        """Creates an Offline C-learning Agent.
        ...
        super(OfflineCLearningAgent, self).__init__(
            time_step_spec,
            action_spec,
            policy=policy,
    ...
    def critic_loss(self,
        ...
        with tf.name_scope('critic_loss'):
            ...
            pred_td_pos_targets1 = tf.clip_by_value(pred_td_pos_targets1, EPSILON, 1. - EPSILON)
