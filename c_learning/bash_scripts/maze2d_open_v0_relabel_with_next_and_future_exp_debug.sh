...
#  nohup \
  python $PROJECT_DIR/train_eval.py \
    ...
    --root_dir ~/offline_c_learning/c_learning_logs_debug/"${EXP_LABEL}"_relabel_with_next_and_future/maze2d_open_v0/$seed
#  > ~/offline_c_learning/c_learning_logs_debug/"${EXP_LABEL}"_relabel_with_next_and_future/maze2d_open_v0/$seed/stream.log 2>&1 &
done
